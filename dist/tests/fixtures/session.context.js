    ...
    '@context': {
        ...
        properties: { id: { readable: true,
            ...
            updated_at: { readable: true,
                ...
                exportable: true,
                type: 'date' },
            fyc_campaign_id: { readable: true,
                writable: false,
                exportable: true,
                type: 'number' },
            affiliation: { type: 'https://um.api.mediapeers.mobi/v20140601/context/affiliation',
                collection: false,
                readable: true,
                writable: false,
                exportable: false },
            ...
            role: { type: 'https://um.api.mediapeers.mobi/v20140601/context/role',
                ...
                writable: false,
                exportable: false },
            powers: { type: 'https://um.api.mediapeers.mobi/v20140601/context/power',
                collection: true,
                readable: true,
                writable: false,
                exportable: false },
            groupings: { type: 'https://um.api.mediapeers.mobi/v20140601/context/group',
                collection: true,
                readable: true,
                writable: false,
                exportable: false },
            protection_checks: { type: 'https://um.api.mediapeers.mobi/v20140601/context/protection_check',
                collection: true,
                readable: true,
                writable: false,
                exportable: false } },
        constants: {},
        member_actions: { create: { method: 'POST',
                expects: null,
            ...
            delete: { method: 'DELETE',
                ...
                template: 'https://um.api.mediapeers.mobi/v20140601/session',
                mappings: [] } },
        collection_actions: { impersonate: { method: 'POST',
                expects: null,
                resource: 'https://um.api.mediapeers.mobi/v20140601/context/session',
                response: 'https://um.api.mediapeers.mobi/v20140601/context/collection',
                template: 'https://um.api.mediapeers.mobi/v20140601/session/impersonate',
                mappings: [] } }
    }
};
